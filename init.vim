...
"" Explore view mappings (for netrw)
...
"" Toggle both line numbers at once
nmap <leader>ll :set invnumber invrelativenumber<CR>
...
"""" If you've confirmed that, try running :ALEInfo
